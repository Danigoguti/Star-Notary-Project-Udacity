...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Star Proof Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerAddress1 == msg.sender || ownerAddress2 == msg.sender, "msg.sender is not owner of _tokenId1 or _tokenId2");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "msg.sender doesnt own the token");
